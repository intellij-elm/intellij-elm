...
class ElmTestRunConfigurationProducer : RunConfigurationProducer<ElmTestRunConfiguration> {

    constructor(configurationFactory: ElmTestConfigurationFactory) : super(configurationFactory)

    constructor(configurationType: ElmTestRunConfigurationType) : super(configurationType)
