...
class ElmPattern(node: ASTNode) : ElmPsiElementImpl(node), ElmPatternChildTag {
     ...
     */
    val child: ElmPatternChildTag get() = findNotNullChildByClass(ElmPatternChildTag::class.java)
