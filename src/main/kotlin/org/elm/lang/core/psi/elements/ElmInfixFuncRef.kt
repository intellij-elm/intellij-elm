...
import org.elm.lang.core.stubs.ElmInfixFuncRefStub

/**
 * A reference to the function that implements an infix operator.
 */
class ElmInfixFuncRef : ElmStubbedElement<ElmInfixFuncRefStub>, ElmReferenceElement {

    constructor(node: ASTNode) :
            super(node)

    constructor(stub: ElmInfixFuncRefStub, stubType: IStubElementType<*, *>) :
            super(stub, stubType)
